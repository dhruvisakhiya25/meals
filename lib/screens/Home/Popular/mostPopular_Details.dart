...
class MostPopularDetails extends StatefulWidget {
  int index;

  MostPopularDetails({Key? key, required this.index}) : super(key: key);

  @override
  State<MostPopularDetails> createState() => _MostPopularDetailsState();
}
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                              image: NetworkImage(
                                document[widget.index]['most image'],
                              ),
                              fit: BoxFit.cover),
                        ),
                      ),
                        ...
                        child: Padding(
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  document[widget.index]['most name'],
                                ...
                                Text(
                                  document[widget.index]['most rate']
                                      .toString(),
                                  style: const TextStyle(
                                      fontSize: 20,
