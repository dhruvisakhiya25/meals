...
class FoodDrink extends StatefulWidget {
  const FoodDrink({Key? key}) : super(key: key);
...
class _FoodDrinkState extends State<FoodDrink> {
  ...
  FirebaseFirestore.instance.collection('fooddrink');
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    documents['fooddrink rate'],
                                  ),
                                  Text(
                                    documents['fooddrink decription'],
                                  ),
