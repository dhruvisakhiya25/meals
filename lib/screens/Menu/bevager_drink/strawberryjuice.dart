...
class StrawberryJuice extends StatefulWidget {
  const StrawberryJuice({Key? key}) : super(key: key);
...
class _StrawberryJuiceState extends State<StrawberryJuice> {
  ...
  FirebaseFirestore.instance.collection('strawberryjuice');
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                  image: NetworkImage(
                                    documents['strawberryjuice image'],
                                  ),
                                  fit: BoxFit.cover),
                            ),
                          ),
                            ...
                            child: Padding(
                              ...
                              child: SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      documents['strawberryjuice name'],
                                    ...
                                    Text(
                                      documents['strawberryjuice rate'],style: TextStyle(
                                        fontSize: 20,
                                    ...
                                    Text(
                                      documents['strawberryjuice decription'],style: TextStyle(
                                      fontSize: 18.5,
                                    ),
                                    ),
