...
class HealthyFood extends StatefulWidget {
  const HealthyFood({Key? key}) : super(key: key);
                              ...
                              child: SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      documents['healthyfood rate'],style: TextStyle(
                                        fontSize: 20,
                                    ...
                                    Text(
                                      documents['healthyfood decription'],
                                      style: TextStyle(
                                        fontSize: 18.5,
                                      ),
                                    ),
